...
Case of 
	...
	: ($color>=0)
		...
		WP_SetCellsBackgroundColor (Form:C1466.selection;$color)
	...
	: ($color=-3)  // transparent 
		...
		WP_SetCellsBackgroundColor (Form:C1466.selection;wk transparent:K81:134)
		
End case 

WP_GetCellsBackgroundColor ($oCurrent)