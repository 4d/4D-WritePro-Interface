...
If (Shift down:C543)
	$pictElem:=$textRange.insertPicture($picture; wk replace:K81:177; wk exclude from range:K81:181)
Else 
	$pictElem:=$textRange.insertPicture($picture; wk replace:K81:177; wk include in range:K81:180)
End if 
