...
var $selectedItem : Text:=Form:C1466.styleSheets.currentValue
...
*/
var $index : Integer:=Form:C1466.styleSheets.index

If (Form:C1466.styleSheets.values.indexOf("-")#-1) && ($index<Form:C1466.styleSheets.values.indexOf("-"))
