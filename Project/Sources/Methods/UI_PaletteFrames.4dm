...
Else 
	...
	OBJECT SET FORMAT:C236(*; "paddingTop"; numFormat+" "+unitName)
	OBJECT SET FORMAT:C236(*; "paddingLeft"; numFormat+" "+unitName)
	OBJECT SET FORMAT:C236(*; "paddingRight"; numFormat+" "+unitName)
	OBJECT SET FORMAT:C236(*; "paddingBottom"; numFormat+" "+unitName)
