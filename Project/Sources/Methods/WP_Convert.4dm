...
If ($toUnit#$fromUnit) & ($value#0)
	...
	WP SET ATTRIBUTES:C1342(oTempArea; wk background width:K81:27; $value)  //wk line height
	
	WP SET ATTRIBUTES:C1342(oTempArea; wk layout unit:K81:78; $toUnit)
	WP GET ATTRIBUTES:C1345(oTempArea; wk background width:K81:27; $value)  //wk margin left
